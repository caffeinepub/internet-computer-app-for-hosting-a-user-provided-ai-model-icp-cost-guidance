...
export interface _SERVICE {
  ...
  'deleteModel' : ActorMethod<[ModelId], undefined>,
  'getAdminModels' : ActorMethod<[], Array<Model>>,
  ...
  >,
  'getMostPopularModels' : ActorMethod<[bigint], Array<Model>>,
  'getMyModels' : ActorMethod<[], Array<Model>>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'updateModelMetadata' : ActorMethod<[ModelMetadataUpdate], undefined>,
}
