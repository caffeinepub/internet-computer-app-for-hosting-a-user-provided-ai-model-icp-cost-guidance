...
export class Backend implements backendInterface {
    ...
    async deleteModel(arg0: ModelId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAdminModels(): Promise<Array<Model>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAdminModels();
    ...
    async getAvailableModels(): Promise<Array<Model>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableModels();
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMostPopularModels(arg0: bigint): Promise<Array<Model>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMostPopularModels(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyModels(): Promise<Array<Model>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyModels();
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Model_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Model): Model {
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ModelInferenceArtifact]): ModelInferenceArtifact | null {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    owner: Principal;
    name: string;
    artifact: [] | [_ModelInferenceArtifact];
    lastInferenceTime: bigint;
    timestamp: bigint;
    payloadSize: bigint;
}): {
    ...
    return {
        id: value.id,
        totalInferenceCount: value.totalInferenceCount,
        owner: value.owner,
        name: value.name,
        artifact: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.artifact)),
        lastInferenceTime: value.lastInferenceTime,
...
function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        name: value.name,
        artifact: value.artifact ? candid_some(value.artifact) : candid_none(),
        payloadSize: value.payloadSize
    };
}
